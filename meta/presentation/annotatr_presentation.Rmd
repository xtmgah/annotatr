...
- The IDH2 mutant prevents methylated CpGs from undergoing the de-methylation pathway. The NBM is the normal bone marrow.
...
- We implemented `annotatr`, an R package that intersects genomic regions with genomic annotations.
    ...
    - **Fast**.
    - Results in summary tables and visualizations that help give context to data, and help develop / answer new questions.
