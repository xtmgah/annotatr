...
visualize_numerical(summarized_scores, annotation_order = NULL, bin_width = 10,
  plot_title = NULL, x_label = NULL, y_label = NULL)

visualize_categorical(summarized_names, x, fill = NULL, x_order = NULL,
...
cpgs_order = c(
  ...
  'hg19_cpg_shelves',
  'hg19_cpg_inter')
visualize_numerical_cpgs = visualize_numerical(
...
print(visualize_numerical_cpgs)
```
...
visualize_cpgs = visualize_categorical(
...
fill_order = c(
  ...
  'hypo',
  'none')
visualize_genes = visualize_categorical(
