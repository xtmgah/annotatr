...
The dataset used in the running example actually has a classification (hyper, hypo, none) and a score (methylation difference between two groups) associated with each region. We will employ both summarization functions in preparation for visualization.
